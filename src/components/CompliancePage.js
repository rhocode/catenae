        ...
        <div className='card'>
          ...
          <div className='card-block faq'>
            <p className='card-text'>
              ...
              <br /> <br />When obtaining and using human tissue, Catenae Bio acts in strict compliance with the following:
              <br />
              <ol>
              ...
              <br />Should there be any questions concerning ethical aspects related to the use of Primary Human Cells, please contact us.
            </p>
          </div>
        </div>
      </div>
